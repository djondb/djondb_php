...
#define SWIGTYPE_p_BSONParseException swig_types[4]
#define SWIGTYPE_p_BSONParser swig_types[5]
#define SWIGTYPE_p_BSONTYPE swig_types[6]
#define SWIGTYPE_p_CommandWriter swig_types[7]
#define SWIGTYPE_p_NetworkInputStream swig_types[8]
#define SWIGTYPE_p_NetworkOutputStream swig_types[9]
#define SWIGTYPE_p_ParseException swig_types[10]
...
#define SWIGTYPE_p_std__vectorT_BSONObj_p_t swig_types[31]
#define SWIGTYPE_p_std__vectorT_BSONObj_p_t__const_iterator swig_types[32]
#define SWIGTYPE_p_std__vectorT_BSONObj_p_t__iterator swig_types[33]
...
static swig_type_info _swigt__p_BSONParseException = {"_p_BSONParseException", "BSONParseException *", 0, 0, (void*)0, 0};
...
static swig_cast_info _swigc__p_BSONParseException[] = {  {&_swigt__p_BSONParseException, 0, 0, 0},{0, 0, 0, 0}};
...
static int le_swig__p_BSONParseException=0; /* handle for BSONParseException */
...
ZEND_NAMED_FUNCTION(_wrap_new_BSONObjVectorPtr__SWIG_1) {
  ...
  /*@SWIG:/usr/local/Cellar/swig/3.0.8/share/swig/3.0.8/php/utils.i,7,CONVERT_INT_IN@*/
...
ZEND_NAMED_FUNCTION(_wrap_BSONArrayObj_select) {
  ...
  /*@SWIG:/usr/local/Cellar/swig/3.0.8/share/swig/3.0.8/php/utils.i,62,CONVERT_STRING_IN@*/
...
ZEND_NAMED_FUNCTION(_wrap_BSONObj_add__SWIG_1) {
  ...
  /*@SWIG:/usr/local/Cellar/swig/3.0.8/share/swig/3.0.8/php/utils.i,52,CONVERT_FLOAT_IN@*/
...
ZEND_NAMED_FUNCTION(_wrap_BSONObj_add__SWIG_2) {
  ...
  /*@SWIG:/usr/local/Cellar/swig/3.0.8/share/swig/3.0.8/php/utils.i,12,CONVERT_LONG_LONG_IN@*/
  switch ((*(args[2]))->type) {
  case IS_DOUBLE:
...
ZEND_NAMED_FUNCTION(_wrap_BSONObj_add__SWIG_8) {
  ...
  /*@SWIG:/usr/local/Cellar/swig/3.0.8/share/swig/3.0.8/php/utils.i,2,CONVERT_BOOL_IN@*/
...
ZEND_NAMED_FUNCTION(_wrap_BSONObj_compare) {
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_BSONObj, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of BSONObj_compare. Expected SWIGTYPE_p_BSONObj");
    }
  }
  if(!arg1) SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
  {
    if(SWIG_ConvertPtr(*args[1], (void **) &arg2, SWIGTYPE_p_BSONObj, 0) < 0 || arg2 == NULL) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 2 of BSONObj_compare. Expected SWIGTYPE_p_BSONObj");
    }
  }
...
ZEND_NAMED_FUNCTION(_wrap_BSONObj_remove) {
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_BSONObj, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of BSONObj_remove. Expected SWIGTYPE_p_BSONObj");
    }
  }
  if(!arg1) SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
...
ZEND_NAMED_FUNCTION(_wrap_new_BSONParseException__SWIG_0) {
  int arg1 ;
  char *arg2 = (char *) 0 ;
  zval **args[2];
  ...
  SWIG_SetPointerZval(return_value, (void *)result, SWIGTYPE_p_BSONParseException, 1);
...
ZEND_NAMED_FUNCTION(_wrap_new_BSONParseException__SWIG_1) {
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_BSONParseException, 0) < 0 || arg1 == NULL) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of new_BSONParseException. Expected SWIGTYPE_p_BSONParseException");
    }
  }
...
ZEND_NAMED_FUNCTION(_wrap_new_BSONParseException) {
  ...
  if (argc == 1) {
    ...
    {
      void *tmp;
      _v = (SWIG_ConvertPtr(*argv[0], (void**)&tmp, SWIGTYPE_p_BSONParseException, 0) >= 0);
    }
    if (_v) {
      _wrap_new_BSONParseException__SWIG_1(INTERNAL_FUNCTION_PARAM_PASSTHRU); return;
    }
  }
  if (argc == 2) {
    int _v;
    ...
    if (_v) {
      _v = (Z_TYPE_PP(argv[1]) == IS_STRING); 
      if (_v) {
        _wrap_new_BSONParseException__SWIG_0(INTERNAL_FUNCTION_PARAM_PASSTHRU); return;
      }
    }
  }
  
  SWIG_ErrorCode() = E_ERROR;
  SWIG_ErrorMsg() = "No matching function for overloaded 'new_BSONParseException'";
  SWIG_FAIL(TSRMLS_C);
}
...
/* This function is designed to be called by the zend list destructors */
/* to typecast and do the actual destruction */
static void __wrap_delete_BSONParseException(zend_rsrc_list_entry *rsrc, const char *type_name TSRMLS_DC) {
  swig_object_wrapper *value=(swig_object_wrapper *) rsrc->ptr ;
  void *ptr=value->ptr ;
  int newobject=value->newobject ;
  ...
  efree(value);
  if (! newobject) return; /* can't delete it! */
  arg1 = (BSONParseException *)SWIG_ZTS_ConvertResourceData(ptr,type_name,SWIGTYPE_p_BSONParseException TSRMLS_CC);
  if (! arg1) zend_error(E_ERROR, "BSONParseException resource already free'd");
  delete arg1;
  return;
fail:
  SWIG_FAIL(TSRMLS_C);
...
ZEND_NAMED_FUNCTION(_wrap_BSONParseException_what) {
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_BSONParseException, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of BSONParseException_what. Expected SWIGTYPE_p_BSONParseException");
    }
  }
  if(!arg1) SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
...
ZEND_NAMED_FUNCTION(_wrap_BSONParseException_errorCode) {
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_BSONParseException, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of BSONParseException_errorCode. Expected SWIGTYPE_p_BSONParseException");
    }
  }
  if(!arg1) SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
...
ZEND_NAMED_FUNCTION(_wrap_DjondbConnection_createIndex) {
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_djondb__DjondbConnection, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of DjondbConnection_createIndex. Expected SWIGTYPE_p_djondb__DjondbConnection");
    }
  }
  if(!arg1) SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
  {
    if(SWIG_ConvertPtr(*args[1], (void **) &arg2, SWIGTYPE_p_BSONObj, 0) < 0 || arg2 == NULL) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 2 of DjondbConnection_createIndex. Expected SWIGTYPE_p_BSONObj");
    }
  }
...
ZEND_NAMED_FUNCTION(_wrap_DjondbConnection_backup__SWIG_0) {
  djondb::DjondbConnection *arg1 = (djondb::DjondbConnection *) 0 ;
  char *arg2 = (char *) 0 ;
  char *arg3 = (char *) 0 ;
  zval **args[3];
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_djondb__DjondbConnection, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of DjondbConnection_backup. Expected SWIGTYPE_p_djondb__DjondbConnection");
    }
  }
  if(!arg1) SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
...
ZEND_NAMED_FUNCTION(_wrap_DjondbConnection_backup__SWIG_1) {
  djondb::DjondbConnection *arg1 = (djondb::DjondbConnection *) 0 ;
  char *arg2 = (char *) 0 ;
  char *arg3 = (char *) 0 ;
  BSONObj *arg4 = 0 ;
  ...
  {
    if(SWIG_ConvertPtr(*args[3], (void **) &arg4, SWIGTYPE_p_BSONObj, 0) < 0 || arg4 == NULL) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 4 of DjondbConnection_backup. Expected SWIGTYPE_p_BSONObj");
    }
  }
...
ZEND_NAMED_FUNCTION(_wrap_DjondbConnection_backup) {
  ...
  if (argc == 3) {
    ...
    if (_v) {
      ...
      if (_v) {
        _v = (Z_TYPE_PP(argv[2]) == IS_STRING); 
        if (_v) {
          _wrap_DjondbConnection_backup__SWIG_0(INTERNAL_FUNCTION_PARAM_PASSTHRU); return;
        }
      }
    }
  }
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        if (_v) {
          ...
          if (_v) {
            _wrap_DjondbConnection_backup__SWIG_1(INTERNAL_FUNCTION_PARAM_PASSTHRU); return;
          }
        }
      }
    }
  ...
  SWIG_ErrorCode() = E_ERROR;
  SWIG_ErrorMsg() = "No matching function for overloaded 'DjondbConnection_backup'";
  SWIG_FAIL(TSRMLS_C);
}
...
static ZEND_RSRC_DTOR_FUNC(_wrap_destroy_p_BSONParseException) {
  __wrap_delete_BSONParseException(rsrc, SWIGTYPE_p_BSONParseException->name TSRMLS_CC);
}
...
/* arginfo subsection */
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_new_bsonobjvectorptr, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_bsonobjvectorptr_size, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_bsonobjvectorptr_capacity, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_bsonobjvectorptr_reserve, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_bsonobjvectorptr_clear, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_bsonobjvectorptr_push, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_bsonobjvectorptr_is_empty, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_bsonobjvectorptr_pop, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_bsonobjvectorptr_get, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_bsonobjvectorptr_set, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
 ZEND_ARG_PASS_INFO(0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_stringvector_set, 0, 0, 0)
 ...
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_new_bsonarrayobj, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_bsonarrayobj_length, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_bsonarrayobj_add, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_bsonarrayobj_addall, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_bsonarrayobj_get, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_bsonarrayobj_tochar, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_bsonarrayobj_select, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_bsonarrayobj_begin, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_bsonarrayobj_end, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_new_bsonobj, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_bsonobj_add, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
 ZEND_ARG_PASS_INFO(0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_bsonobj_has, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_bsonobj_getboolean, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_bsonobj_getint, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_bsonobj_getdouble, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_bsonobj_getlong, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_bsonobj_getstring, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_bsonobj_getbson, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_bsonobj_getbsonarray, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_bsonobj_get, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_bsonobj_getcontent, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
 ZEND_ARG_PASS_INFO(0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_bsonobj_getxpath, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_bsonobj_select, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
 ZEND_ARG_PASS_INFO(0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_bsonobj_type, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_bsonobj_tochar, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_bsonobj_begin, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_bsonobj_end, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_bsonobj_length, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_bsonobj_compare, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_bsonobj_remove, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_new_bsonparseexception, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_bsonparseexception_what, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_bsonparseexception_errorcode, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_new_bsonparser, 0, 0, 0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_bsonparser_parse, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_bsonparser_parsearray, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_parsefilteroperator, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_new_parseexception, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_parseexception_what, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_parseexception_errorcode, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_bson_splitselect, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_bson_subselect, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_convert, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
 ZEND_ARG_PASS_INFO(0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_new_djondbconnection, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_djondbconnection_begintransaction, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_djondbconnection_committransaction, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_djondbconnection_rollbacktransaction, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_djondbconnection_open, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_djondbconnection_close, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_djondbconnection_internalclose, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_djondbconnection_isopen, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_djondbconnection_shutdown, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_djondbconnection_insert, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
 ZEND_ARG_PASS_INFO(0)
 ZEND_ARG_PASS_INFO(0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_djondbconnection_findbykey, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
 ZEND_ARG_PASS_INFO(0)
 ZEND_ARG_PASS_INFO(0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_djondbconnection_find, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
 ZEND_ARG_PASS_INFO(0)
 ZEND_ARG_PASS_INFO(0)
 ZEND_ARG_PASS_INFO(0)
 ...
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_djondbconnection_update, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
 ZEND_ARG_PASS_INFO(0)
 ZEND_ARG_PASS_INFO(0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_djondbconnection_remove, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
 ZEND_ARG_PASS_INFO(0)
 ZEND_ARG_PASS_INFO(0)
 ZEND_ARG_PASS_INFO(0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_djondbconnection_executequery, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_djondbconnection_executeupdate, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_djondbconnection_releasecursor, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_djondbconnection_createindex, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_djondbconnection_dropnamespace, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
 ZEND_ARG_PASS_INFO(0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_djondbconnection_dbs, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_djondbconnection_namespaces, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_djondbconnection_host, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_djondbconnection_backup, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
 ZEND_ARG_PASS_INFO(0)
 ZEND_ARG_PASS_INFO(0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_new_djondbcursor, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_djondbcursor_next, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_djondbcursor_previous, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_djondbcursor_current, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_djondbcursor_length, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_djondbcursor_releasecursor, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_djondbcursor_seek, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_connectionreference__connection_set, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_connectionreference__connection_get, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_connectionreference__references_set, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_connectionreference__references_get, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_new_connectionreference, 0, 0, 0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_new_djondbconnectionmanager, 0, 0, 0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_djondbconnectionmanager_getconnection, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_djondbconnectionmanager_releaseconnection, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
...
static zend_function_entry djonwrapper_functions[] = {
 SWIG_ZEND_NAMED_FE(new_bsonobjvectorptr,_wrap_new_BSONObjVectorPtr,swig_arginfo_new_bsonobjvectorptr)
 SWIG_ZEND_NAMED_FE(bsonobjvectorptr_size,_wrap_BSONObjVectorPtr_size,swig_arginfo_bsonobjvectorptr_size)
 SWIG_ZEND_NAMED_FE(bsonobjvectorptr_capacity,_wrap_BSONObjVectorPtr_capacity,swig_arginfo_bsonobjvectorptr_capacity)
 SWIG_ZEND_NAMED_FE(bsonobjvectorptr_reserve,_wrap_BSONObjVectorPtr_reserve,swig_arginfo_bsonobjvectorptr_reserve)
 SWIG_ZEND_NAMED_FE(bsonobjvectorptr_clear,_wrap_BSONObjVectorPtr_clear,swig_arginfo_bsonobjvectorptr_clear)
 SWIG_ZEND_NAMED_FE(bsonobjvectorptr_push,_wrap_BSONObjVectorPtr_push,swig_arginfo_bsonobjvectorptr_push)
 SWIG_ZEND_NAMED_FE(bsonobjvectorptr_is_empty,_wrap_BSONObjVectorPtr_is_empty,swig_arginfo_bsonobjvectorptr_is_empty)
 SWIG_ZEND_NAMED_FE(bsonobjvectorptr_pop,_wrap_BSONObjVectorPtr_pop,swig_arginfo_bsonobjvectorptr_pop)
 SWIG_ZEND_NAMED_FE(bsonobjvectorptr_get,_wrap_BSONObjVectorPtr_get,swig_arginfo_bsonobjvectorptr_get)
 SWIG_ZEND_NAMED_FE(bsonobjvectorptr_set,_wrap_BSONObjVectorPtr_set,swig_arginfo_bsonobjvectorptr_set)
 ...
 SWIG_ZEND_NAMED_FE(new_bsonarrayobj,_wrap_new_BSONArrayObj,swig_arginfo_new_bsonarrayobj)
 SWIG_ZEND_NAMED_FE(bsonarrayobj_length,_wrap_BSONArrayObj_length,swig_arginfo_bsonarrayobj_length)
 SWIG_ZEND_NAMED_FE(bsonarrayobj_add,_wrap_BSONArrayObj_add,swig_arginfo_bsonarrayobj_add)
 SWIG_ZEND_NAMED_FE(bsonarrayobj_addall,_wrap_BSONArrayObj_addAll,swig_arginfo_bsonarrayobj_addall)
 SWIG_ZEND_NAMED_FE(bsonarrayobj_get,_wrap_BSONArrayObj_get,swig_arginfo_bsonarrayobj_get)
 SWIG_ZEND_NAMED_FE(bsonarrayobj_tochar,_wrap_BSONArrayObj_toChar,swig_arginfo_bsonarrayobj_tochar)
 SWIG_ZEND_NAMED_FE(bsonarrayobj_select,_wrap_BSONArrayObj_select,swig_arginfo_bsonarrayobj_select)
 SWIG_ZEND_NAMED_FE(bsonarrayobj_begin,_wrap_BSONArrayObj_begin,swig_arginfo_bsonarrayobj_begin)
 SWIG_ZEND_NAMED_FE(bsonarrayobj_end,_wrap_BSONArrayObj_end,swig_arginfo_bsonarrayobj_end)
 SWIG_ZEND_NAMED_FE(new_bsonobj,_wrap_new_BSONObj,swig_arginfo_new_bsonobj)
 SWIG_ZEND_NAMED_FE(bsonobj_add,_wrap_BSONObj_add,swig_arginfo_bsonobj_add)
 SWIG_ZEND_NAMED_FE(bsonobj_has,_wrap_BSONObj_has,swig_arginfo_bsonobj_has)
 SWIG_ZEND_NAMED_FE(bsonobj_getboolean,_wrap_BSONObj_getBoolean,swig_arginfo_bsonobj_getboolean)
 SWIG_ZEND_NAMED_FE(bsonobj_getint,_wrap_BSONObj_getInt,swig_arginfo_bsonobj_getint)
 SWIG_ZEND_NAMED_FE(bsonobj_getdouble,_wrap_BSONObj_getDouble,swig_arginfo_bsonobj_getdouble)
 SWIG_ZEND_NAMED_FE(bsonobj_getlong,_wrap_BSONObj_getLong,swig_arginfo_bsonobj_getlong)
 SWIG_ZEND_NAMED_FE(bsonobj_getstring,_wrap_BSONObj_getString,swig_arginfo_bsonobj_getstring)
 SWIG_ZEND_NAMED_FE(bsonobj_getbson,_wrap_BSONObj_getBSON,swig_arginfo_bsonobj_getbson)
 SWIG_ZEND_NAMED_FE(bsonobj_getbsonarray,_wrap_BSONObj_getBSONArray,swig_arginfo_bsonobj_getbsonarray)
 SWIG_ZEND_NAMED_FE(bsonobj_get,_wrap_BSONObj_get,swig_arginfo_bsonobj_get)
 SWIG_ZEND_NAMED_FE(bsonobj_getcontent,_wrap_BSONObj_getContent,swig_arginfo_bsonobj_getcontent)
 SWIG_ZEND_NAMED_FE(bsonobj_getxpath,_wrap_BSONObj_getXpath,swig_arginfo_bsonobj_getxpath)
 SWIG_ZEND_NAMED_FE(bsonobj_select,_wrap_BSONObj_select,swig_arginfo_bsonobj_select)
 SWIG_ZEND_NAMED_FE(bsonobj_type,_wrap_BSONObj_type,swig_arginfo_bsonobj_type)
 SWIG_ZEND_NAMED_FE(bsonobj_tochar,_wrap_BSONObj_toChar,swig_arginfo_bsonobj_tochar)
 SWIG_ZEND_NAMED_FE(bsonobj_begin,_wrap_BSONObj_begin,swig_arginfo_bsonobj_begin)
 SWIG_ZEND_NAMED_FE(bsonobj_end,_wrap_BSONObj_end,swig_arginfo_bsonobj_end)
 SWIG_ZEND_NAMED_FE(bsonobj_length,_wrap_BSONObj_length,swig_arginfo_bsonobj_length)
 SWIG_ZEND_NAMED_FE(bsonobj_compare,_wrap_BSONObj_compare,swig_arginfo_bsonobj_compare)
 SWIG_ZEND_NAMED_FE(bsonobj_remove,_wrap_BSONObj_remove,swig_arginfo_bsonobj_remove)
 SWIG_ZEND_NAMED_FE(new_bsonparseexception,_wrap_new_BSONParseException,swig_arginfo_new_bsonparseexception)
 SWIG_ZEND_NAMED_FE(bsonparseexception_what,_wrap_BSONParseException_what,swig_arginfo_bsonparseexception_what)
 SWIG_ZEND_NAMED_FE(bsonparseexception_errorcode,_wrap_BSONParseException_errorCode,swig_arginfo_bsonparseexception_errorcode)
 SWIG_ZEND_NAMED_FE(new_bsonparser,_wrap_new_BSONParser,swig_arginfo_new_bsonparser)
 SWIG_ZEND_NAMED_FE(bsonparser_parse,_wrap_BSONParser_parse,swig_arginfo_bsonparser_parse)
 SWIG_ZEND_NAMED_FE(bsonparser_parsearray,_wrap_BSONParser_parseArray,swig_arginfo_bsonparser_parsearray)
 SWIG_ZEND_NAMED_FE(parsefilteroperator,_wrap_parseFilterOperator,swig_arginfo_parsefilteroperator)
 SWIG_ZEND_NAMED_FE(new_parseexception,_wrap_new_ParseException,swig_arginfo_new_parseexception)
 SWIG_ZEND_NAMED_FE(parseexception_what,_wrap_ParseException_what,swig_arginfo_parseexception_what)
 SWIG_ZEND_NAMED_FE(parseexception_errorcode,_wrap_ParseException_errorCode,swig_arginfo_parseexception_errorcode)
 SWIG_ZEND_NAMED_FE(bson_splitselect,_wrap_bson_splitSelect,swig_arginfo_bson_splitselect)
 SWIG_ZEND_NAMED_FE(bson_subselect,_wrap_bson_subselect,swig_arginfo_bson_subselect)
 SWIG_ZEND_NAMED_FE(convert,_wrap_convert,swig_arginfo_convert)
 SWIG_ZEND_NAMED_FE(new_djondbconnection,_wrap_new_DjondbConnection,swig_arginfo_new_djondbconnection)
 SWIG_ZEND_NAMED_FE(djondbconnection_begintransaction,_wrap_DjondbConnection_beginTransaction,swig_arginfo_djondbconnection_begintransaction)
 SWIG_ZEND_NAMED_FE(djondbconnection_committransaction,_wrap_DjondbConnection_commitTransaction,swig_arginfo_djondbconnection_committransaction)
 SWIG_ZEND_NAMED_FE(djondbconnection_rollbacktransaction,_wrap_DjondbConnection_rollbackTransaction,swig_arginfo_djondbconnection_rollbacktransaction)
 SWIG_ZEND_NAMED_FE(djondbconnection_open,_wrap_DjondbConnection_open,swig_arginfo_djondbconnection_open)
 SWIG_ZEND_NAMED_FE(djondbconnection_close,_wrap_DjondbConnection_close,swig_arginfo_djondbconnection_close)
 SWIG_ZEND_NAMED_FE(djondbconnection_internalclose,_wrap_DjondbConnection_internalClose,swig_arginfo_djondbconnection_internalclose)
 SWIG_ZEND_NAMED_FE(djondbconnection_isopen,_wrap_DjondbConnection_isOpen,swig_arginfo_djondbconnection_isopen)
 SWIG_ZEND_NAMED_FE(djondbconnection_shutdown,_wrap_DjondbConnection_shutdown,swig_arginfo_djondbconnection_shutdown)
 SWIG_ZEND_NAMED_FE(djondbconnection_insert,_wrap_DjondbConnection_insert,swig_arginfo_djondbconnection_insert)
 SWIG_ZEND_NAMED_FE(djondbconnection_findbykey,_wrap_DjondbConnection_findByKey,swig_arginfo_djondbconnection_findbykey)
 SWIG_ZEND_NAMED_FE(djondbconnection_find,_wrap_DjondbConnection_find,swig_arginfo_djondbconnection_find)
 SWIG_ZEND_NAMED_FE(djondbconnection_update,_wrap_DjondbConnection_update,swig_arginfo_djondbconnection_update)
 SWIG_ZEND_NAMED_FE(djondbconnection_remove,_wrap_DjondbConnection_remove,swig_arginfo_djondbconnection_remove)
 SWIG_ZEND_NAMED_FE(djondbconnection_executequery,_wrap_DjondbConnection_executeQuery,swig_arginfo_djondbconnection_executequery)
 SWIG_ZEND_NAMED_FE(djondbconnection_executeupdate,_wrap_DjondbConnection_executeUpdate,swig_arginfo_djondbconnection_executeupdate)
 SWIG_ZEND_NAMED_FE(djondbconnection_releasecursor,_wrap_DjondbConnection_releaseCursor,swig_arginfo_djondbconnection_releasecursor)
 SWIG_ZEND_NAMED_FE(djondbconnection_createindex,_wrap_DjondbConnection_createIndex,swig_arginfo_djondbconnection_createindex)
 SWIG_ZEND_NAMED_FE(djondbconnection_dropnamespace,_wrap_DjondbConnection_dropNamespace,swig_arginfo_djondbconnection_dropnamespace)
 SWIG_ZEND_NAMED_FE(djondbconnection_dbs,_wrap_DjondbConnection_dbs,swig_arginfo_djondbconnection_dbs)
 SWIG_ZEND_NAMED_FE(djondbconnection_namespaces,_wrap_DjondbConnection_namespaces,swig_arginfo_djondbconnection_namespaces)
 SWIG_ZEND_NAMED_FE(djondbconnection_host,_wrap_DjondbConnection_host,swig_arginfo_djondbconnection_host)
 SWIG_ZEND_NAMED_FE(djondbconnection_backup,_wrap_DjondbConnection_backup,swig_arginfo_djondbconnection_backup)
 SWIG_ZEND_NAMED_FE(new_djondbcursor,_wrap_new_DjondbCursor,swig_arginfo_new_djondbcursor)
 SWIG_ZEND_NAMED_FE(djondbcursor_next,_wrap_DjondbCursor_next,swig_arginfo_djondbcursor_next)
 SWIG_ZEND_NAMED_FE(djondbcursor_previous,_wrap_DjondbCursor_previous,swig_arginfo_djondbcursor_previous)
 SWIG_ZEND_NAMED_FE(djondbcursor_current,_wrap_DjondbCursor_current,swig_arginfo_djondbcursor_current)
 SWIG_ZEND_NAMED_FE(djondbcursor_length,_wrap_DjondbCursor_length,swig_arginfo_djondbcursor_length)
 SWIG_ZEND_NAMED_FE(djondbcursor_releasecursor,_wrap_DjondbCursor_releaseCursor,swig_arginfo_djondbcursor_releasecursor)
 SWIG_ZEND_NAMED_FE(djondbcursor_seek,_wrap_DjondbCursor_seek,swig_arginfo_djondbcursor_seek)
 SWIG_ZEND_NAMED_FE(connectionreference__connection_set,_wrap_ConnectionReference__connection_set,swig_arginfo_connectionreference__connection_set)
 SWIG_ZEND_NAMED_FE(connectionreference__connection_get,_wrap_ConnectionReference__connection_get,swig_arginfo_connectionreference__connection_get)
 SWIG_ZEND_NAMED_FE(connectionreference__references_set,_wrap_ConnectionReference__references_set,swig_arginfo_connectionreference__references_set)
 SWIG_ZEND_NAMED_FE(connectionreference__references_get,_wrap_ConnectionReference__references_get,swig_arginfo_connectionreference__references_get)
 SWIG_ZEND_NAMED_FE(new_connectionreference,_wrap_new_ConnectionReference,swig_arginfo_new_connectionreference)
 SWIG_ZEND_NAMED_FE(new_djondbconnectionmanager,_wrap_new_DjondbConnectionManager,swig_arginfo_new_djondbconnectionmanager)
 SWIG_ZEND_NAMED_FE(djondbconnectionmanager_getconnection,_wrap_DjondbConnectionManager_getConnection,swig_arginfo_djondbconnectionmanager_getconnection)
 SWIG_ZEND_NAMED_FE(djondbconnectionmanager_releaseconnection,_wrap_DjondbConnectionManager_releaseConnection,swig_arginfo_djondbconnectionmanager_releaseconnection)
...
le_swig__p_BSONParseException=zend_register_list_destructors_ex(_wrap_destroy_p_BSONParseException,NULL,(char *)(SWIGTYPE_p_BSONParseException->name),module_number);
SWIG_TypeClientData(SWIGTYPE_p_BSONParseException,&le_swig__p_BSONParseException);
...
/* cinit subsection */
SWIG_LONG_CONSTANT(FO_NONE, (int)FO_NONE);
SWIG_LONG_CONSTANT(FO_TOKEN, (int)FO_TOKEN);
SWIG_LONG_CONSTANT(FO_AND, (int)FO_AND);
SWIG_LONG_CONSTANT(FO_OR, (int)FO_OR);
SWIG_LONG_CONSTANT(FO_EQUALS, (int)FO_EQUALS);
SWIG_LONG_CONSTANT(FO_NOT_EQUALS, (int)FO_NOT_EQUALS);
SWIG_LONG_CONSTANT(FO_PARENTESIS_OPEN, (int)FO_PARENTESIS_OPEN);
SWIG_LONG_CONSTANT(FO_PARENTESIS_CLOSE, (int)FO_PARENTESIS_CLOSE);
SWIG_LONG_CONSTANT(FO_NOT, (int)FO_NOT);
SWIG_LONG_CONSTANT(FO_LESSTHAN, (int)FO_LESSTHAN);
SWIG_LONG_CONSTANT(FO_LESSEQUALTHAN, (int)FO_LESSEQUALTHAN);
SWIG_LONG_CONSTANT(FO_GREATERTHAN, (int)FO_GREATERTHAN);
SWIG_LONG_CONSTANT(FO_GREATEREQUALTHAN, (int)FO_GREATEREQUALTHAN);
SWIG_LONG_CONSTANT(FO_EXISTS, (int)FO_EXISTS);
SWIG_LONG_CONSTANT(ET_CONSTANT, (int)ET_CONSTANT);
SWIG_LONG_CONSTANT(ET_SIMPLE, (int)ET_SIMPLE);
SWIG_LONG_CONSTANT(ET_BINARY, (int)ET_BINARY);
SWIG_LONG_CONSTANT(ET_UNARY, (int)ET_UNARY);
SWIG_LONG_CONSTANT(SERVER_PORT, (int)1243);
